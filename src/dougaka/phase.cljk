(ns dougaka.phase
  "Phase 0→2 staged rollout for dougaka (superproject ADR-2607162200 Layer D;
  same revision the minidrama actor carries as its repo ADR-0002). The phase
  gate can only ever withhold announcement, never force it, and a
  governor-held plan is never announced in any phase.
...
(defn publish-allowed?
  "May a governor-clean video be announced under `phase` with the run's
